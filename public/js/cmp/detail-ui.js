...
consentmentImg.src = 'https://app.consentment.com/poweredbyconsentment-v1.png';
...
header.appendChild(rightContainer);
        ...
        // Tab buttons (removed Services tab)
        const tabs = [
...
toggleInput.style.cssText = `
    ...
    background-color: ${category.essential ? 
        (appearance.disabled_toggle_bg || '#CCCCCC') : 
...
toggleSlider.style.cssText = `
    ...
    border-radius: 50%;
    pointer-events: none;
    opacity: ${category.essential ? '0.8' : '1'};
`;
        ...
        aboutContent.innerHTML = `
            <h3 style="margin-top: 0; color: ${appearance.text_color || '#000000'};"> ${content.about_title || 'About Our Privacy Policy' }</h3>
