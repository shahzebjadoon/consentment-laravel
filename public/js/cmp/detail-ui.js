...
if (appearance.logo_url) {
    ...
    logo.style.cssText = 'max-height: 30px; width: auto;';
    ...
    logoPlaceholder.style.cssText = 'width: 30px; height: 25px;';
    headerLogo.appendChild(logoPlaceholder);
}
...
consentmentImg.style.cssText = 'max-height: 25px; width: auto;';
