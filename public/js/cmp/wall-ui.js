...
(function() {
    ...
    function createMainDialog(config) {
        ...
        // Create tab-like box at the top
        const tabBox = document.createElement('div');
        tabBox.className = 'consentment-tab-box';
        ...
        // Add logo to tab-like box
        const tabLogo = document.createElement('img');
        tabLogo.src = 'https://app.consentment.com/consentment.png';
        tabLogo.alt = 'ConsentMent';
        tabLogo.style.cssText = 'max-height: 25px; width: auto;';
        tabBox.appendChild(tabLogo);
        ...
        if (appearance.logo_url) {
            ...
            logo.alt = appearance.logo_alt_tag || 'Company Logo';
            logo.style.cssText = 'width: 200px; display: block;';
            leftSection.appendChild(logo);
        } else {
            // Add a placeholder logo similar to the one in the screenshot
            const logoPlaceholder = document.createElement('div');
            logoPlaceholder.className = 'consentment-logo-placeholder';
            logoPlaceholder.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="25" viewBox="0 0 32 25"><path d="M16 0C8.832 0 3 5.832 3 13c0 7.168 5.832 13 13 13s13-5.832 13-13C29 5.832 23.168 0 16 0zm0 2c6.087 0 11 4.913 11 11s-4.913 11-11 11S5 19.087 5 13 9.913 2 16 2zm-2 5v12h4V7h-4z" fill="#4d4d4d"/></svg>';
            logoPlaceholder.style.cssText = 'width: 30px; height: 25px; display: block;';
            leftSection.appendChild(logoPlaceholder);
        }
...
`;
        ...
        detailsArrow.style.cssText = 'margin-left: 4px;';
        ...
        */
        ...
        // Append tab to dialog
        dialog.appendChild(tabBox);
    ...
    function setupEventListeners(dialogContainer) {
        ...
        if (saveButton) {
            saveButton.addEventListener('click', function() {
                console.log('[ConsentMent-WallUI] Save Settings button clicked');
                handleSaveSettings();
            });
        }
        ...
        toggles.forEach(toggle => {
            if (!toggle.hasAttribute('disabled')) {
                toggle.addEventListener('click', function() {
                    ...
                    console.log(`[ConsentMent-WallUI] Toggle clicked for ${category}: ${!isChecked}`);
...
if (detailsLink) {
    detailsLink.addEventListener('click', function(e) {
        e.preventDefault();
        console.log('[ConsentMent-WallUI] Details link clicked - opening detail view');
    ...
    function handleSaveSettings() {
        console.log('[ConsentMent-WallUI] Handling Save Settings');
        ...
        console.log('[ConsentMent-WallUI] Custom consent settings:', services);
    ...
    console.log('[ConsentMent-WallUI] Wall UI script initialized');
})();
