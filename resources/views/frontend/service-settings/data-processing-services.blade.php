    ...
    <div class="card-body" style="padding-top: 0;">
        ...
        <div class="tab-content">
            <div style="margin-top: 20px;">
                <h3 style="margin-bottom: 20px;">Data Processing Services Detected <i class="fas fa-info-circle" style="color: #ccc; font-size: 16px; vertical-align: middle;"></i></h3>
...
<div class="services-list">
    ...
    <div class="service-item">
        <div class="service-header">
            <div class="service-info">
                <h4>{{ $service->name ?? $service->service_name ?? 'Unknown Service' }}</h4>
    ...
    @endforelse
                ...
                <!-- Add DPS Button -->
                <button class="btn-add-dps">
                    <i class="fas fa-plus"></i> Add DPS via Database
                </button>
                
                <!-- Custom Data Processing Services -->
                <div class="custom-services-section">
                    <h3>Custom Data Processing Services <i class="fas fa-info-circle"></i></h3>
                    <div class="custom-buttons">
                        <button class="btn-custom-action">
                            <i class="fas fa-plus"></i> Create Custom DPS
                        </button>
                        <button class="btn-custom-action">
                            <i class="fas fa-plus"></i> Customize Predefined DPS
                        </button>
                    </div>
                </div>
            </div>
