...
<div class="card" style="margin-bottom: 30px; width: 100%;">
    <div class="card-header" style="border-bottom: none; padding-bottom: 0;">
        <h3 class="page-title">Service Settings <i class="fas fa-info-circle" style="color: #ccc; font-size: 16px; vertical-align: middle;"></i></h3>
    </div>
    <div class="card-body" style="padding-top: 0;">
        ...
        <div class="tab-content">
            <div style="margin-top: 20px;">
                <h3 style="margin-bottom: 20px;">Categories <i class="fas fa-info-circle" style="color: #ccc; font-size: 16px; vertical-align: middle;"></i></h3>
                ...
                <div class="detail-group">
                    ...
                    <div class="settings-options">
                        <div class="checkbox-group">
                            ...
                            <label for="mark-essential-{{ $category->id }}">Mark category as essential <i class="fas fa-info-circle"></i></label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="detail-group">
                    <div class="data-processing-header">
                        <div class="data-processing-title">
                            ...
                            <span class="service-count">{{ $category->servicesList->count() }}</span>
                        </div>
                    ...
                    <div class="data-processing-list hidden" id="dpsList{{ $category->id }}">
                        <ul>
                            @forelse($category->servicesList as $service)
                            <li>{{ $service->name }}</li>
                            @empty
...
document.querySelectorAll('[id^="toggleDps"]').forEach(function(btn) {
    ...
    document.getElementById('toggleDpsFunctional').addEventListener('click', function(e) {
        e.stopPropagation();
        const dpsList = document.getElementById('dpsListFunctional');
        const isHidden = dpsList.classList.contains('hidden');
    ...
    document.getElementById('toggleDpsEssential').addEventListener('click', function(e) {
        e.stopPropagation();
        const dpsList = document.getElementById('dpsListEssential');
        const isHidden = dpsList.classList.contains('hidden');
