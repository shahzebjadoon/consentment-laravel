...
<div class="card" style="margin-bottom: 30px; width: 100%;">
    ...
    <div class="card-header-actions" style=" padding: 15px 20px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <form action="{{ route('frontend.appearance.save', ['company_id' => $company->id, 'config_id' => $configuration->id]) }}" method="POST" id="stylingForm" enctype="multipart/form-data">
            ...
            <input type="hidden" name="active_toggle_bg" value="{{ $appearance->active_toggle_bg ?? '#888888' }}" id="activeToggleBgInput">

            <input type="hidden" name="active_toggle_icon" value="{{ $appearance->active_toggle_icon ?? '#FFFFFF' }}" id="activeToggleIconInput">

            <input type="hidden" name="inactive_toggle_bg" value="{{ $appearance->inactive_toggle_bg ?? '#696A80' }}" id="inactiveToggleBgInput">

            <input type="hidden" name="inactive_toggle_icon" value="{{ $appearance->inactive_toggle_icon ?? '#CF7A7A' }}" id="inactiveToggleIconInput">

            <input type="hidden" name="disabled_toggle_bg" value="{{ $appearance->disabled_toggle_bg ?? '#CF7A7A' }}" id="disabledToggleBgInput">

            <input type="hidden" name="disabled_toggle_icon" value="{{ $appearance->disabled_toggle_icon ?? '#FFFFFF' }}" id="disabledToggleIconInput">
    ...
    <div class="card-body" style="padding-top: 0;">
        ...
        <div style="display: flex; margin-bottom: 20px;">
            ...
            <a href="{{ route('frontend.appearance.layout', ['company_id' => $company->id, 'config_id' => $configuration->id]) }}" 
               ...
               style="padding: 12px 20px; border: 1px solid #dee2e6; border-bottom: none; border-radius: 4px 4px 0 0; text-decoration: none; font-weight: 800;{{ $activeTab == 'layout' ? 'background-color: white; color: #333; font-weight: 800;' : 'background-color: #f8f9fa; color: #666;' }} margin-right: 5px;">
            ...
            <a href="{{ route('frontend.appearance.styling', ['company_id' => $company->id, 'config_id' => $configuration->id]) }}" 
               ...
               style="padding: 12px 20px; border: 1px solid #dee2e6; border-bottom: none; border-radius: 4px 4px 0 0; text-decoration: none; font-weight: 800;{{ $activeTab == 'styling' ? 'background-color: white; color: #333; font-weight: 800;' : 'background-color: #f8f9fa; color: #666;' }} margin-right: 5px;">
                    ...
                    <div class="color-inputs">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-1" style="background-color: {{ $appearance->background_color ?? '#FFFFFF' }};"></div>

                                <input type="text" id="selected-color-1" value="{{ $appearance->background_color ?? '#FFFFFF' }}" class="color-value" data-target="backgroundColorInput">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-2" style="background-color: {{ $appearance->text_color ?? '#000000' }};"></div>

                                <input type="text" id="selected-color-2" value="{{ $appearance->text_color ?? '#000000' }}" class="color-value" data-target="textColorInput">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-3" style="background-color: {{ $appearance->link_color ?? '#CF7A7A' }};"></div>

                                <input type="text" id="selected-color-3" value="{{ $appearance->link_color ?? '#CF7A7A' }}" class="color-value" data-target="linkColorInput">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-4" style="background-color: {{ $appearance->tab_color ?? '#0026CB' }};"></div>

                                <input type="text" id="selected-color-4" value="{{ $appearance->tab_color ?? '#0026CB' }}" class="color-value" data-target="tabColorInput">
                    ...
                    <div class="setting-options" style="{{ $appearance->background_overlay ? 'display: flex;' : 'display: none;' }}">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-5" style="background-color: {{ $appearance->overlay_color ?? '#000000' }};"></div>

                                <input type="text" id="selected-color-5" value="{{ $appearance->overlay_color ?? '#000000' }}" class="color-value" data-target="overlayColorInput">
    ...
    <div class="logo-upload-container">
        ...
        @if ($appearance->logo_url)
            ...
            <div class="current-logo">
                ...
                <img src="{{ $appearance->logo_url }}" id="logo_preview" alt="Current Logo" style="max-height: 80px; max-width: 100%; margin-bottom: 10px;">
                ...
                <div class="button-colors">
                    ...
                    <div class="button-color-row">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-6" style="background-color: {{ $appearance->deny_button_bg ?? '#CF7A7A' }};"></div>

                                <input type="text" id="selected-color-6" value="{{ $appearance->deny_button_bg ?? '#CF7A7A' }}" class="color-value" data-target="denyButtonBgInput">
                        ...
                        <div class="color-input-group">
                            ...
                            <div class="color-input">
                                ...
                                <div class="color-picker" id="picker-7" style="background-color: {{ $appearance->deny_button_text ?? '#FFFFFF' }};"></div>

                                <input type="text" id="selected-color-7" value="{{ $appearance->deny_button_text ?? '#FFFFFF' }}" class="color-value" data-target="denyButtonTextInput">
                    ...
                    <div class="button-color-row">
                        ...
                        <div class="color-input-group">
                            ...
                            <label>Save Button & Accept (Background)</label>

                            <div class="color-input">

                                <div class="color-picker" id="picker-8" style="background-color: {{ $appearance->save_button_bg ?? '#CF7A7A' }};"></div>

                                <input type="text" id="selected-color-8" value="{{ $appearance->save_button_bg ?? '#CF7A7A' }}" class="color-value" data-target="saveButtonBgInput">
                        ...
                        <div class="color-input-group">
                            ...
                            <label>Save & Accept Button (Text)</label>

                            <div class="color-input">

                                <div class="color-picker" id="picker-9" style="background-color: {{ $appearance->save_button_text ?? '#FFFFFF' }};"></div>

                                <input type="text" id="selected-color-9" value="{{ $appearance->save_button_text ?? '#FFFFFF' }}" class="color-value" data-target="saveButtonTextInput">
...
<div class="styling-section">
        ...
        <div class="toggle-color-row">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-10" style="background-color: {{ $appearance->active_toggle_bg ?? '#888888' }};"></div>

                    <input type="text" id="selected-color-10" value="{{ $appearance->active_toggle_bg ?? '#888888' }}" class="color-value" data-target="activeToggleBgInput">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-11" style="background-color: {{ $appearance->active_toggle_icon ?? '#FFFFFF' }};"></div>

                    <input type="text" id="selected-color-11" value="{{ $appearance->active_toggle_icon ?? '#FFFFFF' }}" class="color-value" data-target="activeToggleIconInput">
        ...
        <div class="toggle-color-row">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-12" style="background-color: {{ $appearance->inactive_toggle_bg ?? '#696A80' }};"></div>

                    <input type="text" id ="selected-color-12" value="{{ $appearance->inactive_toggle_bg ?? '#696A80' }}" class="color-value" data-target="inactiveToggleBgInput">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-13" style="background-color: {{ $appearance->inactive_toggle_icon ?? '#CF7A7A' }};"></div>

                    <input type="text" id="selected-color-13" value="{{ $appearance->inactive_toggle_icon ?? '#CF7A7A' }}" class="color-value" data-target="inactiveToggleIconInput">
        ...
        <div class="toggle-color-row">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-14" style="background-color: {{ $appearance->disabled_toggle_bg ?? '#CF7A7A' }};"></div>

                    <input type="text" id="selected-color-14" value="{{ $appearance->disabled_toggle_bg ?? '#CF7A7A' }}" class="color-value" data-target="disabledToggleBgInput">
            ...
            <div class="color-input-group">
                ...
                <div class="color-input">
                    ...
                    <div class="color-picker" id="picker-15" style="background-color: {{ $appearance->disabled_toggle_icon ?? '#FFFFFF' }};"></div>

                    <input type="text" id="selected-color-15" value="{{ $appearance->disabled_toggle_icon ?? '#FFFFFF' }}" class="color-value" data-target="disabledToggleIconInput">
    ...
    <!-- Modify your toggle preview section to include direct inline script -->

<div class="cc-toggle-preview">

    <h5>Toggle Preview</h5>

    <div class="cc-preview-toggles">

        <div class="cc-preview-toggle">

            <div class="cc-toggle-label">Active</div>

            <div class="cc-toggle-visual cc-active" style="background-color: {{ $appearance->active_toggle_bg ?? '#888888' }};">

                <div class="cc-toggle-handle" style="background-color: {{ $appearance->active_toggle_icon ?? '#FFFFFF' }};"></div>
        ...
        <div class="cc-preview-toggle">
            ...
            <div class="cc-toggle-label">Inactive</div>

            <div class="cc-toggle-visual cc-inactive" style="background-color: {{ $appearance->inactive_toggle_bg ?? '#696A80' }};">

                <div class="cc-toggle-handle" style="background-color: {{ $appearance->inactive_toggle_icon ?? '#CF7A7A' }};"></div>
        ...
        <div class="cc-preview-toggle">
            ...
            <div class="cc-toggle-label">Disabled</div>

            <div class="cc-toggle-visual cc-disabled" style="background-color: {{ $appearance->disabled_toggle_bg ?? '#CF7A7A' }};">

                <div class="cc-toggle-handle" style="background-color: {{ $appearance->disabled_toggle_icon ?? '#FFFFFF' }};"></div>
    ...
    <script>
        ...
        // Get toggle preview elements

        const activeToggleVisual = document.querySelector('.cc-toggle-visual.cc-active');

        const activeToggleHandle = document.querySelector('.cc-toggle-visual.cc-active .cc-toggle-handle');

        const inactiveToggleVisual = document.querySelector('.cc-toggle-visual.cc-inactive');

        const inactiveToggleHandle = document.querySelector('.cc-toggle-visual.cc-inactive .cc-toggle-handle');

        const disabledToggleVisual = document.querySelector('.cc-toggle-visual.cc-disabled');

        const disabledToggleHandle = document.querySelector('.cc-toggle-visual.cc-disabled .cc-toggle-handle');

        

        // Connect color inputs to toggle preview elements

        document.querySelector('.color-value[data-target="activeToggleBgInput"]').addEventListener('input', function() {

            activeToggleVisual.style.backgroundColor = this.value;

        });

        

        document.querySelector('.color-value[data-target="activeToggleIconInput"]').addEventListener('input', function() {

            activeToggleHandle.style.backgroundColor = this.value;

        });

        

        document.querySelector('.color-value[data-target="inactiveToggleBgInput"]').addEventListener('input', function() {

            inactiveToggleVisual.style.backgroundColor = this.value;

        });

        

        document.querySelector('.color-value[data-target="inactiveToggleIconInput"]').addEventListener('input', function() {

            inactiveToggleHandle.style.backgroundColor = this.value;

        });

        

        document.querySelector('.color-value[data-target="disabledToggleBgInput"]').addEventListener('input', function() {

            disabledToggleVisual.style.backgroundColor = this.value;

        });

        

        document.querySelector('.color-value[data-target="disabledToggleIconInput"]').addEventListener('input', function() {

            disabledToggleHandle.style.backgroundColor = this.value;
...
/* Custom Toggle Preview Styles with cc- prefix */
...
.cc-toggle-visual.cc-active .cc-toggle-handle {
...
.cc-toggle-visual.cc-inactive .cc-toggle-handle,

.cc-toggle-visual.cc-disabled .cc-toggle-handle {
...
$(document).ready(function() {
  $('.color-picker').each(function(index) {
    ...
    const colorOutputId = pickerId.replace('picker', 'selected-color');
    const defaultColor = $('#' + colorOutputId).val();

    const pickr = Pickr.create({
      el: pickerElement,
      theme: 'nano',
      default: defaultColor, // Set default color in Pickr
      components: {
        preview: true,
        opacity: true,
        hue: true,
...
document.getElementById('activeToggleIconInput').addEventListener('input', function() {

    // This would need additional implementation to change the toggle icon color
...
document.getElementById('inactiveToggleIconInput').addEventListener('input', function() {
...
document.getElementById('disabledToggleIconInput').addEventListener('input', function() {
...
// Real-time toggle preview updates

document.querySelectorAll('.color-value[data-target="activeToggleBgInput"]').forEach(function(input) {
...
document.querySelectorAll('.color-value[data-target="activeToggleIconInput"]').forEach(function(input) {

    input.addEventListener('input', function() {

        // For the toggle "dot"

        const activeDot = document.querySelector('.toggle-visual.active:after');

        if (activeDot) {

            activeDot.style.backgroundColor = this.value;

        } else {

            // Add the style directly since :after can't be accessed directly with JS

            const styleSheet = document.createElement('style');

            styleSheet.textContent = `.toggle-visual.active:after { background-color: ${this.value} !important; }`;
...
document.querySelectorAll('.color-value[data-target="inactiveToggleBgInput"]').forEach(function(input) {
...
document.querySelectorAll('.color-value[data-target="inactiveToggleIconInput"]').forEach(function(input) {
    ...
    input.addEventListener('input', function() {
        ...
        styleSheet.textContent = `.toggle-visual.inactive:after { background-color: ${this.value} !important; }`;
...
document.querySelectorAll('.color-value[data-target="disabledToggleBgInput"]').forEach(function(input) {
...
document.querySelectorAll('.color-value[data-target="disabledToggleIconInput"]').forEach(function(input) {
    ...
    input.addEventListener('input', function() {
        ...
        styleSheet.textContent = `.toggle-visual.disabled:after { background-color: ${this.value} !important; }`;
