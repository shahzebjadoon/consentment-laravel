                            ...
                            <div class="page-wrapper">
                                ...
                                <div class="layout-container">
                                    ...
                                    <div id="preview">
                                        ...
                                        <img id="layout-preview-img" src="https://app.consentment.com/{{$appearance->layout_type}}-ui.png" alt="{{$appearance->layout_type}} Layout">
...
<style>
    ...
    .layout-option-group {
        ...
        flex: 0.3; /* Reduced by 70% (from 1 to 0.3) */
...
<style>
    ...
    .layout-preview-container {
      ...
      flex: 0.7; /* Added 70% of the width (from the layout-option-group) */
...
$(document).ready(function() {
        ...
        $('.layout-options input[type="radio"]').on('change', function() {
            ...
            // Update the layout type in the hidden input

            $('#layoutTypeInput').val($(this).val());

            

            // Update the preview image with the -ui suffix

            $('#layout-preview-img').attr('src', 'https://app.consentment.com/' + $(this).val() + '-ui.png');
            ...
            $('#' + selectedRadio + '-icon').addClass('active-icon');
